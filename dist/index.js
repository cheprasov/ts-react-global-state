...
"use strict";
eval("\nObject.defineProperty(exports, \"__esModule\", ({ value: true }));\nexports.isStateTupleExtenderType = void 0;\nvar isStateTupleExtenderType = function (value) {\n    return Array.isArray(value) && value.length === 2 && 'isStateTuple' in value;\n};\nexports.isStateTupleExtenderType = isStateTupleExtenderType;\n\n\n//# sourceURL=webpack://@cheprasov/react-global-state/./src/GlobalState/types.ts?");
